...
<div class="publication-layout mt-4">
  ...
  <div class="publication-panel">
    ...
    <div>
      <b>Загружено</b>
      <span>DailyDialog, StatCan, WebLINX, FaithDial, MultiWOZ, AirDialog, CANARD, ClarQA, MANtIS, Abg-CoQA</span>
    </div>
    <div>
      <b>Воспроизводимость</b>
      <span>для Abg-CoQA используется конфиг <code>coqa_abg_fr</code> и штатная команда загрузки</span>
    </div>
    <div>
      <b>Осталось</b>
...
Сказать: это общий командный результат; русские и французские артефакты опубликованы в DeepPavlov, а не в личных репозиториях. Отдельно отметить, что MANtIS и Abg-CoQA уже загружены, а дальше остаются два самых крупных набора: WoW и Coral.
-->
