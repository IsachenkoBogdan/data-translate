...
<div class="publication-layout mt-4">
  ...
  <div class="publication-panel">
    ...
    <div>
      <b>Данные</b>
      <span>русские и французские версии опубликованы в организации DeepPavlov</span>
    </div>
    <div>
      <b>Код</b>
      <span>репозитории содержат настройки перевода, проверки качества и команды публикации</span>
    </div>
    <div>
      <b>Описание</b>
      <span>в README и описании проекта зафиксированы роли, результаты и ограничения</span>
    </div>
  </div>
</div>
...
Сказать: это общий командный результат; русские и французские артефакты опубликованы в DeepPavlov, а не в личных репозиториях. Сделать акцент не на списке статусов, а на том, что проверяющий может открыть данные, код и описание проекта.
-->
...
<div class="two-col mt-5">
  ...
  <div class="card accent">
    ...
    <ul>
      <li>расширить ручную проверку качества на самые крупные поисковые наборы</li>
      <li>добавить ручную двуязычную проверку на небольшой выборке</li>
      <li>запустить многоязычную оценку DialogMTEB</li>
      <li>поддерживать загрузочные конфиги для новых версий наборов данных</li>
    </ul>
  </div>
</div>
